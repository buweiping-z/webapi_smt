...
namespace webapi.Migrations
{
    ...
    [Migration("20260628023053_AddPositionPhotos")]
    partial class AddPositionPhotos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webapi.Models.InspectionPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("RecordId")
                        .HasDatabaseName("idx_photos_record");

                    b.HasIndex("RecordId", "ItemName")
                        .HasDatabaseName("idx_photos_item");

                    b.ToTable("inspection_photos", (string)null);
                });

            modelBuilder.Entity("webapi.Models.InspectionPositionPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("TemplateId")
                        .HasDatabaseName("idx_position_photos_template");

                    b.ToTable("inspection_position_photos", (string)null);
                });
            ...
            modelBuilder.Entity("webapi.Models.InspectionPositionPhoto", b =>
                {
                    b.HasOne("webapi.Models.InspectionTemplate", null)
                        .WithMany("PositionPhotos")
